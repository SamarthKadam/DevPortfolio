  ...
  return (
    <div>
      ...
      <div className="w-[100%] m h-[100%] border-t-4 border-r-2 max-[742px]:mt-10 border-l-2 border-l-[#999999] border-r-[#999999] border-white">
        ...
        <div className="grid  grid-cols-[1fr,2fr,7fr,3fr] max-[1500px]:grid-cols-[1fr,2fr,6fr,2fr] max-[1040px]:grid-cols-[0.6fr,1.4fr,5fr,1.8fr] max-[900px]:grid-cols-[0.5fr,5fr,1.6fr] max-[632px]:grid-cols-[5fr,1.6fr]">
