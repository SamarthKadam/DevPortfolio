    ...
    <div className='mt-5 mx-4  h-[100%] relative'>
        <div className="border-2 h-[85%] border-[#3434]">
            <div className='h-6 bg-[#ffffff] border-bottom-2 flex items-center gap-2 px-2'>
             <div className='bg-[#D9846B] h-3 w-3 max-[992px]:h-2 max-[992px]:w-2 rounded-full'></div>
             <div className='bg-[#D6BD74] h-3 w-3 max-[992px]:h-2 max-[992px]:w-2 rounded-full'></div>
             <div className='bg-[#9DCF9D] h-3 w-3 max-[992px]:h-2 max-[992px]:w-2 rounded-full'></div>
            </div>
        ...
        <div className='flex gap-1'>
        <div className='bg-[#75D2F0] h-2 max-[992px]:h-1 w-[60%] rounded-md'></div>
        <div className='bg-[#F1D65E] h-2 max-[992px]:h-1 w-[20%] rounded-md'></div>
        </div>
        ...
        <div className='flex gap-1'>
        <div className='bg-[#75D2F0] h-2 max-[992px]:h-1 w-[15%] rounded-md'></div>
        <div className='bg-[#9070F4] h-2 max-[992px]:h-1 w-[20%] rounded-md'></div>
