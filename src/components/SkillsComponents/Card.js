  ...
  return (
    <div className="box-border px-6 py-8">
      ...
      <div className="flex justify-end mt-2">
        <div className="w-[95%] font-georama box-border px-4 border-l-2 text-lg border-white">Experienced in both REST and Graphql: Express, NodeJS, JWT, Mongoose, Graphql, Mongodb, SQL, SQLite</div>
      </div>
      <div className="mt-4 font-mono text-[#5E5E60] font-bold">{'<h3>'}</div>
    </div>
  );
