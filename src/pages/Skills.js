...
export default function Skills() {
  return (
    <div id='skills' className='px-[10%] max-[1300px]:px-[5%] py-20 bg-[#04090F]'>
        <div className="text-center font-bold max-[1300px]:text-6xl max-[992px]:text-5xl text-white text-7xl font-dmSans">My Expertise</div>
