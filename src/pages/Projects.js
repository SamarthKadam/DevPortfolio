  ...
  return (
    <div id="projects" className='px-[10%] max-[1300px]:px-[5%]  py-20 bg-[#04090F] text-white w-[100%]'>
        ...
        <div className='flex max-[940px]:flex-col mt-10 gap-4'>
          ...
          <a target="_blank" rel="noreferrer" className='max-[940px]:flex max-[940px]:justify-end' href='https://github.com/SamarthKadam/PomodoroApp-RN'><img alt='Project' className='h-72 rounded-xl max-[1500px]:h-64 max-[1140px]:h-52' src={img4}></img></a> 
        </div>
        ...
        <a target="_blank" className='max-[940px]:flex max-[940px]:justify-end'  rel="noreferrer" href='https://github.com/SamarthKadam/fonkeyType'><img alt='Project' className='h-72 rounded-xl max-[1500px]:h-64 max-[1140px]:h-52' src={img2}></img> </a>
        </div>
