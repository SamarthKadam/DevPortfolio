...
Send me an email or contact me via instant message!</div>
          ...
          <div className='flex flex-row gap-4 mt-4 justify-center'>
            <a href='https://www.linkedin.com/in/samarth-kadam-119a25209/'><img alt='info' className='w-10 max-[992px]:w-7' src={img2}></img></a>
            <a href='https://github.com/SamarthKadam'><img alt='info' className='w-10 max-[992px]:w-7' src={img1}></img></a>
            <a href='https://twitter.com/Samarth69908166'><img alt='info' className='w-10 max-[992px]:w-7' src={img3}></img></a>
          </div>
          <div className='mt-4 flex flex-col items-center text-sm'>
            <div className='flex items-center gap-2'><img alt='info' className='h-5 max-[992px]:h-3' src={gmail}></img>samarthskadam14@gmail.com</div>
            <div className='flex items-center gap-2 mt-1'><img alt='info' className='h-5 max-[992px]:h-3' src={phone}></img> +91 9483933877</div>
          </div>
          </div>
        </div>
      </div>
